...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Tag&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.label, label) || other.label == label));
}
...
@override
String toString() {
  return 'Tag(slug: $slug, label: $label)';
}
...
class _Tag implements Tag {
  const _Tag({required this.slug, required this.label});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Tag&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.label, label) || other.label == label));
}
